...
# Table of Contents
- [Entity Relationship Diagram](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#entity-relationship-diagram-erd)
- [Data Definition Language (DDL)](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#data-definition-language-ddl)
	- [Create Database](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#create-database-)
	- [Drop Database](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#drop-database-)
	- [Create Table](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#create-table-)
	- [Alter](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#alter-)
	- [Truncate](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#truncate-)
- [Data Manipulation Language (DML)](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#data-manipulation-language-dml)
	- [Insert](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#insert-)
	- [Update](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#update-)
	- [Delete](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#mysql-delete-statement)
- [Data Query Language (DQL)](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#data-query-language-dql)
	- [Select](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#select-)
- [Data Control Language (DCL)](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#data-control-language-dcl)
	- [Grant](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#grant-)
	- [Revoke](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#revoke-)
- [Index](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#index)
	- [Create Index](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#create-index-)
	-  [Drop Index](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#drop-index-)
- [Clauses](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#clauses)
	- [Where Clause](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#where-clause-)
	- [From Clause](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#from-clause-)
	- [Order By Clause](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#order-by-clause-)
	- [Group By Clause](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#group-by-clause-)
- [Conditions](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#conditions)
	- [And Operator](3eb46242aad791aefa762d89a01f631aa5c09f1c73c3bae55df33bcaaa769c33caeea5adbc48)
	- [Or Operator](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#or-)
	- [Not Operator](3eb46242aad791aefa762d89a01f631aa5c09f1c73c3bae55df33bcaaa769c33caeea5adbc48)
	- [Like Operator](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#like-operator-)
	- [Between Operator](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#between-operator-)
	- [In Operator](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#in-operator-)
- [Joins](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#joins)
- [Aliases](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#aliases)
- [Aggregate functions](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#aggregate-functions)
- [Stored Procedure Basics](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#stored-procedure-basics)
	- [Executing A Stored Procedure](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#executing-a-stored-procedure-)
        - [In Parameters](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#in-parameters-)
        - [Out Parameters](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#out--parameters-)
        - [InOut Parameters](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#inout--parameters-)
- [Temporary Table](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#mysql-temporary-table)
	- [Temporary Table](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#mysql-temporary-table)
	- [Create Temporary Table](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#mysql--create-temporary-table--statement)
- [Views](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#mysql-views)
- [Functions](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#functions)
- [Trigger](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#trigger)
- [Cursor](https://github.com/Ferozkhanroz/Documentation/blob/main/MySQL.md#cursor)
